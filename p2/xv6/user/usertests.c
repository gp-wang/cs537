...
//#define ptimeline(pid, msg) printf(1,"process pid["
...
main(int argc, char *argv[])
{
   ...
   printf(1, "hticks+lticks child 1: %d\n", lticks[0]+hticks[0]);
   printf(1, "hticks+lticks child 2: %d\n", lticks[1]+hticks[1]);
   //check(ratio > .15 && ratio < .66, "ratio should be about 1/3");
  ...
  /* //  struct pstat pst; */
  /* /\* struct pstat *pst; *\/ */
  /* /\* pst=(void *)malloc(sizeof(struct pstat)); *\/ */
  /* /\* //  getpinfo(&pst); *\/ */
  /* /\*   getpinfo(pst); *\/ */
  /* /\* int i; *\/ */
  /* /\* for(i=0;i<NPROC;i++) { *\/ */
  /* /\*   //    printf(stdout,"\nthe pid of proc[i] is %d.",i,(&pst)->pid[i]); *\/ */
  /* /\*       printf(stdout,"\nthe pid of proc[i] is %d.",i,pst->pid[i]); *\/ */
  /* /\* } *\/ */
